...
} from '#src/util/temporal-to-internationalized';

describe('temporal-to-internationalized', () => {
  ...
  describe('temporalToInternationalizedDate', () => {
    test('converts a Temporal.ZonedDateTime to a ZonedDateTime', () => {
      const value = Temporal.ZonedDateTime.from('2024-06-15T12:30:45.5-05:00[America/Chicago]');
      const result = temporalToInternationalizedDate(value);
  ...
  describe('temporalToInternationalizedTime', () => {
    test('converts a Temporal.ZonedDateTime to a ZonedDateTime', () => {
      const value = Temporal.ZonedDateTime.from('2024-06-15T12:30:45.5-05:00[America/Chicago]');
      const result = temporalToInternationalizedTime(value);
