...
} from '#src/util/internationalized-to-temporal';

describe('internationalized-to-temporal', () => {
  ...
  describe('internationalizedToTemporalDate', () => {
    test('converts a ZonedDateTime to a Temporal.ZonedDateTime', () => {
      const value = new ZonedDateTime(2024, 6, 15, 'America/Chicago', -5 * 60 * 60 * 1000, 12, 30, 45, 500);
      const result = internationalizedToTemporalDate(value);
  ...
  describe('internationalizedToTemporalTime', () => {
    test('converts a ZonedDateTime to a Temporal.ZonedDateTime', () => {
      const value = new ZonedDateTime(2024, 6, 15, 'America/Chicago', -5 * 60 * 60 * 1000, 12, 30, 45, 500);
      const result = internationalizedToTemporalTime(value);
